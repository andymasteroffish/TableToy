...
void CupTracker::debugUpdate(){
    //do we need anything here?
}

void CupTracker::debugDraw(){
...
void CupTracker::mousePressed(int x, int y, int button){
...
void CupTracker::mouseDragged(int x, int y, int button){
    if (!usingMouseAndKeyboard) return;
...
void CupTracker::mouseReleased(int x, int y, int button){
    if (!usingMouseAndKeyboard) return;
...
void CupTracker::keyPressed(int key){
    if (!usingMouseAndKeyboard) return;
...
void CupTracker::debugAddCup(int typeID){
    CupInfo thisCupInfo;
...
void CupTracker::debugRemoveCup(int idNum){
